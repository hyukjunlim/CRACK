...
class BaseTrainer(ABC):
    ...
    def load_checkpoint(self, checkpoint_path):
        ...
        self.model.module.mpflow.pretrained_TransBlockV2_1.load_state_dict(self.model.module.blocks[0].state_dict())
        self.model.module.mpflow.pretrained_TransBlockV2_2.load_state_dict(self.model.module.blocks[-1].state_dict())
