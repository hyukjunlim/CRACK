...
class EquivariantMPFlow(nn.Module):
    ...
    def __init__(
        ...
        self.pretrained_TransBlockV2_1 = TransBlockV2(
            sphere_channels,
            attn_hidden_channels,
            num_heads,
            attn_alpha_channels,
        ...
        self.pretrained_TransBlockV2_2 = TransBlockV2(
            sphere_channels,
            attn_hidden_channels,
            num_heads,
            attn_alpha_channels,
    ...
    def forward(self, x, t, atomic_numbers, edge_distance, edge_index, batch):
        ...
        x = self.pretrained_TransBlockV2_1(x, 
            atomic_numbers,
            edge_distance,
            edge_index,
            batch=batch
        ...
        x = self.pretrained_TransBlockV2_2(x, 
            atomic_numbers,
            edge_distance,
            edge_index,
            batch=batch)
