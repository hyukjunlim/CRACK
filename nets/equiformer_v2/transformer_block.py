...
class FeedForwardNetwork_noamp(torch.nn.Module):
    """
    FeedForwardNetwork_noamp: Perform feedforward network with S2 activation or gate activation
    ...
    def __init__(
        ...
        super(FeedForwardNetwork_noamp, self).__init__()
        self.sphere_channels = sphere_channels
        self.hidden_channels = hidden_channels
        self.output_channels = output_channels
        self.lmax_list = lmax_list
